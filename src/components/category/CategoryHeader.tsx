...
const ProReitoriasIcon = () => (
  <svg width="100%" height="100%" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M1 21H21M4.33333 17V10M8.77778 17V10M13.2222 17V10M17.6667 17V10M11 1L19.8889 6H2.11111L11 1Z" stroke="#4769FF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
const AssuntosEstudantisIcon = () => (
  <svg width="100%" height="100%" viewBox="0 0 16 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 21V19C15 17.9391 14.5786 16.9217 13.8284 16.1716C13.0783 15.4214 12.0609 15 11 15H5C3.93913 15 2.92172 15.4214 2.17157 16.1716C1.42143 16.9217 1 17.9391 1 19V21" stroke="#4769FF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
...
const CentroIdiomasIcon = () => (
  <svg width="100%" height="100%" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M4 7L10 13M3 13L9 7L11 4M1 4H13M6 1H7M21 21L16 11L11 21M13 17H19" stroke="#4769FF" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
